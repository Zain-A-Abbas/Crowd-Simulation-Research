...
## Adds a resource to the resources array. Can be given a String key if it needs
## to be manually retrieved at any point after being added here 
func add_resource(new_resource: StorageResource, key: String = ""):
	resources.append(new_resource)
	if key != "":
		named_resources[key] = new_resource

## Same as above, but just adds as an array
func add_resources(new_resources: Array[StorageResource]):
