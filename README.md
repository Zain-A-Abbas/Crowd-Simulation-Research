...
This repository contains various crowd simulation shaders simulations using compute shaders in [Godot 4.7.1](https://godotengine.org/download/archive/4.7.1-stable/). The program itself is not expected to be compiled, and instead runs directly in Godot through the use of a custom plugin.
